...
[plantuml, "cdi-meta1", "svg", height="95%", width="100%"]
----
@startuml
...
[plantuml, "cdi-meta2", "svg", height="95%", width="100%"]
----
@startuml
...
[.statement]
Read my SPI post: http://j.mp/spipost
